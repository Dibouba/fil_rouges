...
insert into `employer`(`emp_id`,`emp_pos_id`,`emp_sup_id`,`emp_dep_id`,`emp_nom`,`emp_pre`,`emp_genre`,`emp_voie`,`emp_nro_voie`,`emp_codpos`,`emp_ville`,`emp_pays_id`,`emp_phone`,`emp_mail`,`emp_date_emb`,`emp_nbr_enf`,`emp_sal`)
values (1,1,null,1,`DURAND`,`Georges`,`M`,`Boulevard Balzac`,10,94320,`BRY-SUR-MARNE`,`FR`,0630014277,`durandgeorges@yahoo.zp`,01/01/1999,3,20000.00),
       ...
       (9,8,14,5,`SOUANE`,`Brahim`,`M`,`Rue salouel`,3,80680,`Berne`,`FR`,0600012001,`souanebrahim@gm.fr`,03/01/2000,3,14000.OO),
       (10,8,14,5,`BOUZA`,`Soul`,`M`,`Avenue Gorgette`,1,69000,`Villiers`,`FR`,0704569000,`bouzasoul1@ht.com`,02/01/2000,3,16000.00),
       ...
       (16,14,3,1,`YOUSSEF`,`Karim`,`M`,`Avenue Midrette`,76,56020,`Ponin`,`FR`,0670030000,`youssefkarim@ml.fr`,09/01/2015,3,15000.00),
       (17,12,14,3,`WARMER`,`Elisabeth`,`F`,`Rue Moulin`,40,77800,`Pente`,`FR`,0656043423,`elisabethwarmer@cl.fr`,09/09/2006,14000.00),
...
insert  into `client`(`cli_id`, `cli_nom`, `cli_pre`, `cli_voie`, `cli_nro_voie`,`cli_codpos`,`cli_ville`, `cli_phone`, `cli_mail`, `cli_type`, `cli_emp_id`, `cli_pays_id`)
values (1,`LIGNAC`,`Gerome`,`Rue de Bastille`,2,75012,`Paris`,0606009000,`lignacgerome@ya.com`,`particulier`,14,`FR`),
       (2,`KOLON`,`Harouna`,`Rue verte`,10,1028,`Bruxelles`,00325890890003,`kolonharouna`,`professionnel`,14,`BE`),
       (3,`SIMONE`,`Elisabeth`,`Rue Lacuée`,4,75012,`Paris`,0700012003,`simoneelisabeth`,`particulier`,4,`FR`),
